...
// 年度更新(全部員の学年+1。中学1年生は据え置き)は二段階確認+24時間の取り消し猶予つき
// (year-rollover/plan.md。破壊的操作は確認ダイアログ+実行ログ)。
// 卒団は年度更新ではなく部員の行詳細から1人ずつ行う(grade-junior-high/plan.md 設計判断3)。
    ...
    <Shell title="部員管理">
      <main>
        ...
        <div className="acard">
          ...
          <p className="anote">
            行をタップで詳細(伝達事項全文・参加可能曜日/時間・招待コード)と編集(名前・呼び名・生年月日・身長・性別)、その子を卒団にする操作。生年月日を直すと学年も変わります。年度更新は全部員の学年+1のみで(中学1年生は据え置き・卒団はしません)、24時間以内なら1回だけ取り消せます
          </p>
        </div>
