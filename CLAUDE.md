...
4. **個人情報は最小保持。** 保持するのは LINEユーザーID(暗号化)/子どもの名前・学年・生年月日・身長・性別/伝達事項/参加可能曜日・時間帯 のみ。
   生年月日・身長は子ども本人のみ(学年判定と成長記録のため)。保護者本人の LINE表示名・プロフィール画像・電話番号・住所・生年月日は保存しない。アクセストークンは永続化しない。
...
- 破壊的操作(年度更新・卒団・卒団後のデータ削除・LINE送信)は確認ダイアログ+実行ログを残す
...
| 年度更新 | 4月に全部員の学年を+1する一括処理(中学1年生は上限なので据え置き)。卒団はここでは行わず、部員管理から1人ずつ行う |
