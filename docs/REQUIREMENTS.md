...
- 初回登録(3ステップ):
  ...
  - ③入力内容の確認: ①②で入力した内容(お子さんごとに お名前 / よみ / 呼び名 / 生年月日 / 学年 / 身長 / 性別、続けて 参加できる曜日 / 時間帯 / 続柄 / コーチへの伝達事項)を一覧で表示する。任意項目(呼び名・伝達事項)が空の場合は「未入力」と表示する
...
| 9 | 家族の設定 | 子どもの招待コード表示・コピー、連携済み家族の一覧、子どもの姓 / 姓のよみ / 名 / 名のよみ / 呼び名 / 生年月日 / 身長 / 性別の修正(学年は生年月日から再計算) |
