...
- [ ] `announcements-guardian.ts`: listPublished / getPublished、保護者 API 2ルート
- [ ] ホームのお知らせ一覧(最新5件+「すべて見る」)、一覧ページ、詳細ページ
- [ ] Integration(保護者 API+RLS・下書き 404)/ E2E(管理 API で公開→ホーム→詳細)
